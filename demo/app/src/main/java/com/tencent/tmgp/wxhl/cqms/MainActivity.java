...
import com.pq.tools.FullScreenUtil;
import com.pq.tools.QuickNotifier;
import com.pq.tools.PqWebview;
...
public class MainActivity extends QuickActivity {
    ...
    private QuickNotifier iquickListener=new QuickNotifier() {
        ...
        public void loginSuccess(UserInfo info){
            isLogin=true;
            showTip("登录成功");
            wv.callJs("loginSuccess(\""+info.getUID()+"\",\""+info.getToken()+"\")");
        }
        @Override
        ...
        public void paySuccess(String sdkOrderID, String cpOrderID, String extrasParams) {
            ...
            wv.callJs("paySuccess(\""+cpOrderID+"\",\""+sdkOrderID+"\")");
        }
        @Override
    ...
    private void createWebview() {
        ...
        wv.regFunc(MainActivity.this,"qk");
