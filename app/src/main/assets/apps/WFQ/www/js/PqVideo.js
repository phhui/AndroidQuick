...
(function(PqVideo){
	...
	PqVideo.playBtnStr='<div id="playBtn" style="width:100%;height:100px;text-align:center;z-index:999;position:absolute;margin-top:300px;display:none"><img src="./css/play.png" width="100" height="100" /></div>';
    ...
    PqVideo.exitBtnStr= '<div id="exitBtn" style="width:100px;height:100px;z-index:999;position:absolute;top:0;margin-top:0px;"><img src="./css/goback.png" /></div>';
